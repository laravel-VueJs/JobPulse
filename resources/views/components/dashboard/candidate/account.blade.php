<div class="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 lg:py-10 mx-auto">
    <div class="my-4 max-w-screen-md border px-4 shadow-xl sm:mx-4 sm:rounded-xl sm:px-4 sm:py-4 md:mx-auto">
        ...
        <div class="flex flex-col gap-4 border-b py-4 sm:flex-row">
            ...
            <input readonly placeholder="email@domain.com" class="w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1">
        </div>
        <div class="flex flex-col gap-4 border-b py-4 sm:flex-row">
            ...
            <input placeholder="Last Name" class="mb-2 w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 sm:mr-4 sm:mb-0 focus:ring-1">
        </div>
        <div class="flex flex-col gap-4 border-b py-4 sm:flex-row">
            <p class="shrink-0 w-32 font-medium">Change Password</p>
            <input placeholder="Password" class="mb-2 w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 sm:mr-4 sm:mb-0 focus:ring-1">
        </div>
        <div class="flex flex-col gap-4 py-4  lg:flex-row">
            ...
            <div class="flex h-56 w-full flex-col items-center justify-center gap-4 rounded-xl border border-dashed border-gray-300 p-5 text-center">
                <img src="https://componentland.com/images/ddHJYlQqOzyOKm4CSCY8o.png" class="h-16 w-16 rounded-full">
