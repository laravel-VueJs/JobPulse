                ...
                <div class="bg-white rounded-md dark:bg-gray-800">
                    <div class="p-4">
                        <div class="flex items-center justify-between mb-3">
                                <span
                                    class="inline-block px-2 py-1 text-sm text-indigo-500 rounded-full dark:bg-gray-700 dark:text-gray-400 bg-indigo-50">
                                    Frontend
                                </span>
                            <h2 class="text-sm font-medium dark:text-gray-400">Activated</h2>
                        </div>
