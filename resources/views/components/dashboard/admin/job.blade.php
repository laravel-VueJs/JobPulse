<div class="container mx-auto pt-3">
    <h1 class="text-2xl font-bold mb-2">All jobs</h1>
    <div class="overflow-x-auto">
        <div class=" text-right">
            <button class="bg-indigo-500 text-white text-sm font-semibold p-2 rounded">Sorting By Companies</button>
            <button class="bg-indigo-500 text-white text-sm font-semibold p-2 rounded">Sorting By Status</button>
        </div>
