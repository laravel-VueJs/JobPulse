                    ...
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            <div class="flex justify-between items-center">
                                ...
                                <a class="text-sm text-indigo-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ route('sendOtp') }}">Forgot password?</a>
                            </div>
                            <div class="relative">
                        ...
                        <div class="flex items-center">
                            <div class="flex">
                                <input id="remember-me" type="checkbox" class="shrink-0 mt-0.5 border-gray-200 rounded text-indigo-600 pointer-events-none focus:ring-indigo-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-indigo-500 dark:checked:border-indigo-500 dark:focus:ring-offset-gray-800">
                            </div>
                            <div class="ms-3">
                        ...
                        <!-- End Checkbox -->
                        <button onclick="fillEmailAndPassword()" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
